...
export default function FeedbackDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {success && (
        <div role="status" aria-live="polite" aria-atomic="true" className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 text-green-800 dark:text-green-400 flex items-start gap-3">
      ...
      {error && (
        <div role="alert" className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 text-red-800 dark:text-red-400 flex items-start gap-3">
